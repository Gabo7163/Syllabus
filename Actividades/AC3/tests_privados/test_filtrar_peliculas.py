...
class TestFiltrarPeliculas(unittest.TestCase):
    ...
    def test_filtrar_peliculas_por_director(self):
        ...
        peliculas = [
            Pelicula(4, 'Batman: el caballero de la noche', 'Christopher Nolan', 2008, 9.0),
            Pelicula(6, 'El origen', 'Christopher Nolan', 2010, 8.8),
            Pelicula(16, 'Interstelar', 'Christopher Nolan', 2014, 8.6)
        ]
    ...
    def test_filtrar_peliculas_por_rating_min(self):
        ...
        peliculas = [
            Pelicula(5, 'El club de la pelea', 'David Fincher', 1999, 8.8)
        ]
        self.assertIsInstance(datos, (filter, map, Generator))
        self.assertSequenceEqual(list(datos), peliculas)
    ...
    def test_filtrar_peliculas_por_rating_max(self):
        ...
        peliculas = [
            Pelicula(20, 'Red Social', 'David Fincher', 2010, 7.7)
        ]
        self.assertIsInstance(datos, (filter, map, Generator))
        self.assertSequenceEqual(list(datos), peliculas)
    ...
    def test_filtrar_peliculas_todo(self):
        ...
        peliculas = [
            Pelicula(8, 'Buenos muchachos', 'Martin Scorsese', 1990, 8.7),
            Pelicula(13, 'Los infiltrados', 'Martin Scorsese', 2006, 8.5)
        ]
        self.assertIsInstance(datos, (filter, map, Generator))
        self.assertSequenceEqual(list(datos), peliculas)
