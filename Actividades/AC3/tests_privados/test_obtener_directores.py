...
class TestObtenerDirectores(unittest.TestCase):
    ...
    def generador_peliculas(self, variacion):
        ...
        if variacion == 1:
            yield Pelicula(16, 'Interstelar', 'Christopher Edward Nolan', 2014, 8.6)
        elif variacion == 2:
            yield Pelicula(8, 'Buenos muchachos', 'Martin Charles Scorsese', 1990, 8.7)
            yield Pelicula(13, 'Los infiltrados', 'Martin Charles Scorsese', 2006, 8.5)
        elif variacion == 3:
            yield Pelicula(5, 'El club de la pelea', 'David Fincher', 1999, 8.8)
            yield Pelicula(18, 'Casablanca', 'Michael Curtiz', 1942, 8.5)
            yield Pelicula(19, 'El Gran Gatsby', 'Mark Anthony Luhrmann', 2013, 7.2)
        elif variacion == 4:
            yield Pelicula(4, 'Batman: el caballero de la noche', 'Christopher Edward Nolan', 2008, 9.0)
            yield Pelicula(17, 'Lo que el viento se llevo', 'Victor Fleming', 1939, 8.1)
            yield Pelicula(6, 'El origen', 'Christopher Edward Nolan', 2010, 8.8)
    ...
    def test_obtener_directores_1(self):
        ...
        self.assertCountEqual(list(datos), ['Christopher Edward Nolan'])
    ...
    def test_obtener_directores_2(self):
        ...
        lista_esperada = ['Martin Charles Scorsese', 'Martin Charles Scorsese']
    ...
    def test_obtener_directores_3(self):
        ...
        lista_esperada = ['David Fincher', 'Michael Curtiz', 'Mark Anthony Luhrmann']
    ...
    def test_obtener_directores_4(self):
        ...
        lista_esperada = ['Christopher Edward Nolan', 'Victor Fleming', 'Christopher Edward Nolan', 'Lana Wachowski', 'David Fincher', 'David Fincher']
        self.assertCountEqual(list(datos), lista_esperada)
