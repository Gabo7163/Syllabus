...
class TestObtenerEstrenos(unittest.TestCase):
    ...
    def test_obtener_estrenos_1(self):
        ...
        datos = funciones.obtener_estrenos(self.generador_peliculas(1), 2000)
    ...
    def test_obtener_estrenos_2(self):
        ...
        datos = funciones.obtener_estrenos(self.generador_peliculas(2), 2002)
        self.assertIsInstance(datos, (filter, map, Generator))

        lista_esperada = ['The Departed']
    ...
    def test_obtener_estrenos_3(self):
        ...
        datos = funciones.obtener_estrenos(self.generador_peliculas(3), 2000)
        self.assertIsInstance(datos, (filter, map, Generator))
    ...
    def test_obtener_estrenos_4(self):
        ...
        datos = funciones.obtener_estrenos(self.generador_peliculas(4), 1911)
        self.assertIsInstance(datos, (filter, map, Generator))
    ...
    def test_obtener_estrenos_vacio(self):
        ...
        datos = funciones.obtener_estrenos(self.generador_peliculas(5), 1911)
        self.assertIsInstance(datos, (filter, map, Generator))
    ...
    def test_obtener_estrenos_vacio_estreno_mayor(self):
        ...
        datos = funciones.obtener_estrenos(self.generador_peliculas(4), 2023)
        self.assertIsInstance(datos, (filter, map, Generator))
