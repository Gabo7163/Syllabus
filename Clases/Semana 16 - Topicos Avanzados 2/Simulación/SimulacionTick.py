...
class Simulación:
    ...
    def avanzar_tick(self) -> None:
        '''
        Identifica las personas "dispuestas" a comprar un almuerzo y
        las agrega a la cola de cada puesto de comida. Posteriormente,
        cada puesto atiende una cierta cantidad de clientes en su cola.
        Finalmente, si sucedió un evento durante  este tick, se imprime la hora.
        '''
        print(f'\n{self.hora:-^100}')
